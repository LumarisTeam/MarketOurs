...
namespace MarketOurs.Data.Migrations
{
    ...
    [Migration("20260815130706_AddPostParadeDBSearch")]
    partial class AddPostParadeDBSearch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketOurs.Data.DataModels.ReportModel", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("MarketOurs.Data.DataModels.TeacherCommentModel", b =>
                {
                    ...
                    b.HasIndex("Key")
                        .HasDatabaseName("teacher_comments_search_idx")
                        .HasAnnotation("ParadeDB:IndexFieldAliases", new[] { "", "", "", "", "" })
                        .HasAnnotation("ParadeDB:IndexFieldKinds", new[] { "property", "property", "property", "property", "property" })
                        .HasAnnotation("ParadeDB:IndexFieldOpclasses", new[] { "", "", "", "", "" })
                        .HasAnnotation("ParadeDB:IndexFieldProperties", new[] { "Key", "TeacherName", "CourseName", "IsReview", "CreatedOn" })
                        .HasAnnotation("ParadeDB:IndexFieldTokenizers", new[] { "", "pdb.chinese_compatible", "pdb.chinese_compatible", "", "" })
                        .HasAnnotation("ParadeDB:IndexKeyProperty", "Key");
